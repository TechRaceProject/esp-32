...
// char *ssid_wifi = "Bbox-8B395AC0";            // Le nom du réseau WiFi
// char *password_wifi = "ScDn9t6dAd5A9EhrS2"; // Le password du WiFi
// char *ssid_wifi = "Merci pour l'info bro";            // Le nom du réseau WiFi
// char *password_wifi = "rajeeth93"; // Le password du WiFi
// char *ssid_wifi = "Peche";            // Le nom du réseau WiFi
// char *password_wifi = "111111111"; // Le password du WiFi
char *ssid_wifi = "Merci pour l'info bro";            // Le nom du réseau WiFi
char *password_wifi = "rajeeth93"; // Le password du WiFi

const char *mqtt_server = "192.168.208.67"; // L'IP de votre broker MQTT (ta machine, ifconfig | grep 192, a mettre sur postman)
const int mqtt_interval_ms = 5000;          // L'interval en ms entre deux envois de données

IPAddress localIP(192, 168, 208, 90); // l'IP que vous voulez donner à votre voiture (faire attention a ce que les 3 premieres partie de l'ip soit toujours identique à celle de votre machine)

IPAddress localGateway(192,168,208,193); // L'IP de la gateway de votre réseau "route -n get default"
IPAddress localSubnet(255, 255, 255, 0);  // Le sous réseau
